...
static char font[]                        = "JetBrains Mono:style=Bold:size=9:antialias=true:autohint=true";
static char dmenufont[]                   = "JetBrains Mono:style=Bold:size=9:antialias=true:autohint=true";
...
static const Key keys[] = {
  ...
  { Mod1Mask,                     XK_z,          spawn,             SHCMD("pactl set-source-mute @DEFAULT_SOURCE@ toggle; kill -43 $(pidof dwmblocks)") },
  ...
  { MODKEY,                       XK_F12,        togglescratch,     {.ui = 5 } },
  TAGKEYS(                        XK_1,                             0)
  TAGKEYS(                        XK_2,                             1)
  TAGKEYS(                        XK_3,                             2)
  TAGKEYS(                        XK_4,                             3)
